...
-- ----------------------------------------------------------------------------
-- Stored Procedure: sp_Load_FactClaims
-- ----------------------------------------------------------------------------
-- TODO: Cai dat sp_Load_FactClaims voi Lookup Surrogate Keys, MERGE va Audit Log
/*
CREATE OR ALTER PROCEDURE dbo.sp_Load_FactClaims
...
BEGIN
    ...
    VALUES (@BatchId, 'sp_Load_FactClaims', @StartTime, 'RUNNING');
    ...
    BEGIN TRY
        ...
        MERGE dbo.Fact_Claims AS Target
        ...
        WHEN NOT MATCHED THEN
            INSERT (CustomerKey, PolicyKey, DateKey, RegionKey, ClaimAmount, ClaimCount)
            VALUES (Source.CustomerKey, Source.PolicyKey, Source.DateKey, Source.RegionKey, Source.ClaimAmount, Source.ClaimCount);
        */
